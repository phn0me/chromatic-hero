...
Inspired by the loop of Diablo II grinding and the exploration of Zelda, but stripped down to a single core system.

## How It Works
## The Affinity Cycle

There are four colors: Red, Green, Yellow, Blue. They follow a strict cycle:
...
If you are curious about the design logic or how the systems fit together:
    ...
    docs/DESIGN.md - The full Game Design Document
    docs/CRAFTING.md - Details on the loot and crafting economy
